...
(1, '试点大学', 'pilot-university', '上海', '上海', 'active', NOW(), NOW());

INSERT INTO categories (id, name, code, sort_order, created_at, updated_at) VALUES
(1, '考试报名', 'exam', 10, NOW(), NOW()),
(2, '评奖评优', 'scholarship', 20, NOW(), NOW()),
(3, '保研考研', 'research', 30, NOW(), NOW()),
(4, '实习招聘', 'internship', 40, NOW(), NOW()),
(5, '教务事务', 'academic', 50, NOW(), NOW()),
(6, '竞赛大创', 'competition', 60, NOW(), NOW());

INSERT INTO tags (id, name, type, color, created_at, updated_at) VALUES
(1, '快截止', 'risk', '#FF9500', NOW(), NOW()),
(2, '高风险', 'risk', '#FF3B30', NOW(), NOW()),
(3, '影响综测', 'goal', '#34C759', NOW(), NOW()),
(4, '适合保研', 'goal', '#007AFF', NOW(), NOW()),
(5, '需要材料', 'action', '#5856D6', NOW(), NOW()),
(6, '适合大一', 'grade', '#5AC8FA', NOW(), NOW()),
(7, '适合大三', 'grade', '#AF52DE', NOW(), NOW()),
(8, '官方通知', 'source', '#6E6E73', NOW(), NOW());
...
(1, '2026 年上半年大学英语四六级报名确认', 1, '全校', '全体本科生', 1, 'high', 'high', DATE_ADD(NOW(), INTERVAL 1 DAY),
 ...
 'published', TRUE, TRUE, TRUE, TRUE, 80, NOW(), NOW(), NOW()),
(2, '国家奖学金与校级奖学金材料提交', 1, '全校', '大二至大四', 2, 'high', 'high', DATE_ADD(NOW(), INTERVAL 5 DAY),
 ...
 'published', TRUE, FALSE, TRUE, FALSE, 60, NOW(), NOW(), NOW()),
(3, '大学生创新创业训练计划项目申报', 1, '全校', '大一至大三', 6, 'medium', 'medium', DATE_ADD(NOW(), INTERVAL 12 DAY),
 ...
 'published', TRUE, FALSE, FALSE, FALSE, 35, NOW(), NOW(), NOW()),
(4, '2026 届毕业生图像采集补拍安排', 1, '全校', '大四', 5, 'medium', 'high', DATE_ADD(NOW(), INTERVAL 3 DAY),
 ...
 'published', FALSE, FALSE, TRUE, TRUE, 45, NOW(), NOW(), NOW());
